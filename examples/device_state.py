    ...
    try:
        async with MelCloudHomeClient() as client:
            ...
            for device in devices:
                ...
                print(f"  Temperature Range: {caps.min_set_temperature}°C - {caps.max_set_temperature}°C")
                ...
                if caps.has_hot_water:
                    print(f"  Tank Temperature Range: {caps.min_set_tank_temperature}°C - {caps.max_set_tank_temperature}°C")
